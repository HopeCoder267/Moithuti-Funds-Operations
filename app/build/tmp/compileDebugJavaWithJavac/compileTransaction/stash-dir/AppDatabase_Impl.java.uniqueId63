...
import com.moithuti.funds.data.local.dao.BufferDao_Impl;
...
import com.moithuti.funds.data.local.dao.MonthlyBalanceDao_Impl;
...
import com.moithuti.funds.data.local.dao.ProfitTrackerDao_Impl;
...
public final class AppDatabase_Impl extends AppDatabase {
  ...
  private volatile MonthlyBalanceDao _monthlyBalanceDao;

  private volatile ProfitTrackerDao _profitTrackerDao;
  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(4) {
      ...
      public void createAllTables(@NonNull final SupportSQLiteDatabase db) {
        ...
        db.execSQL("CREATE INDEX IF NOT EXISTS `index_profit_tracker_yearMonth` ON `profit_tracker` (`yearMonth`)");
        db.execSQL("CREATE UNIQUE INDEX IF NOT EXISTS `index_profit_tracker_investorId_yearMonth` ON `profit_tracker` (`investorId`, `yearMonth`)");
        db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '20f452af23d591d9be4125a2bd024a4e')");
      }
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        _columnsBuffers.put("investorId", new TableInfo.Column("investorId", "TEXT", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsBuffers.put("amount", new TableInfo.Column("amount", "REAL", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsBuffers.put("reason", new TableInfo.Column("reason", "TEXT", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsBuffers.put("createdDate", new TableInfo.Column("createdDate", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsBuffers.put("lastModified", new TableInfo.Column("lastModified", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsBuffers.put("syncStatus", new TableInfo.Column("syncStatus", "TEXT", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsBuffers.put("deleted", new TableInfo.Column("deleted", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        final HashSet<TableInfo.ForeignKey> _foreignKeysBuffers = new HashSet<TableInfo.ForeignKey>(1);
        _foreignKeysBuffers.add(new TableInfo.ForeignKey("investors", "CASCADE", "NO ACTION", Arrays.asList("investorId"), Arrays.asList("uuid")));
        final HashSet<TableInfo.Index> _indicesBuffers = new HashSet<TableInfo.Index>(2);
        _indicesBuffers.add(new TableInfo.Index("index_buffers_uuid", true, Arrays.asList("uuid"), Arrays.asList("ASC")));
        _indicesBuffers.add(new TableInfo.Index("index_buffers_investorId", false, Arrays.asList("investorId"), Arrays.asList("ASC")));
        final TableInfo _infoBuffers = new TableInfo("buffers", _columnsBuffers, _foreignKeysBuffers, _indicesBuffers);
        final TableInfo _existingBuffers = TableInfo.read(db, "buffers");
        if (!_infoBuffers.equals(_existingBuffers)) {
          return new RoomOpenHelper.ValidationResult(false, "buffers(com.moithuti.funds.data.local.entity.BufferEntity).\n"
                  + " Expected:\n" + _infoBuffers + "\n"
                  + " Found:\n" + _existingBuffers);
        }
        final HashMap<String, TableInfo.Column> _columnsMonthlyBalances = new HashMap<String, TableInfo.Column>(9);
        _columnsMonthlyBalances.put("uuid", new TableInfo.Column("uuid", "TEXT", true, 1, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsMonthlyBalances.put("investorId", new TableInfo.Column("investorId", "TEXT", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsMonthlyBalances.put("yearMonth", new TableInfo.Column("yearMonth", "TEXT", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsMonthlyBalances.put("balance", new TableInfo.Column("balance", "REAL", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsMonthlyBalances.put("monthlyTopUp", new TableInfo.Column("monthlyTopUp", "REAL", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsMonthlyBalances.put("createdDate", new TableInfo.Column("createdDate", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsMonthlyBalances.put("lastModified", new TableInfo.Column("lastModified", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsMonthlyBalances.put("syncStatus", new TableInfo.Column("syncStatus", "TEXT", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsMonthlyBalances.put("deleted", new TableInfo.Column("deleted", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        final HashSet<TableInfo.ForeignKey> _foreignKeysMonthlyBalances = new HashSet<TableInfo.ForeignKey>(1);
        _foreignKeysMonthlyBalances.add(new TableInfo.ForeignKey("investors", "CASCADE", "NO ACTION", Arrays.asList("investorId"), Arrays.asList("uuid")));
        final HashSet<TableInfo.Index> _indicesMonthlyBalances = new HashSet<TableInfo.Index>(2);
        _indicesMonthlyBalances.add(new TableInfo.Index("index_monthly_balances_uuid", true, Arrays.asList("uuid"), Arrays.asList("ASC")));
        _indicesMonthlyBalances.add(new TableInfo.Index("index_monthly_balances_investorId_yearMonth", true, Arrays.asList("investorId", "yearMonth"), Arrays.asList("ASC", "ASC")));
        final TableInfo _infoMonthlyBalances = new TableInfo("monthly_balances", _columnsMonthlyBalances, _foreignKeysMonthlyBalances, _indicesMonthlyBalances);
        final TableInfo _existingMonthlyBalances = TableInfo.read(db, "monthly_balances");
        if (!_infoMonthlyBalances.equals(_existingMonthlyBalances)) {
          return new RoomOpenHelper.ValidationResult(false, "monthly_balances(com.moithuti.funds.data.local.entity.MonthlyBalanceEntity).\n"
        ...
        _columnsProfitTracker.put("yearMonth", new TableInfo.Column("yearMonth", "TEXT", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsProfitTracker.put("monthlyProfit", new TableInfo.Column("monthlyProfit", "REAL", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsProfitTracker.put("cumulativeProfit", new TableInfo.Column("cumulativeProfit", "REAL", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsProfitTracker.put("monthlyInterest", new TableInfo.Column("monthlyInterest", "REAL", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsProfitTracker.put("cumulativeInterest", new TableInfo.Column("cumulativeInterest", "REAL", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsProfitTracker.put("monthlyLoansIssued", new TableInfo.Column("monthlyLoansIssued", "REAL", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsProfitTracker.put("monthlyRepaymentsReceived", new TableInfo.Column("monthlyRepaymentsReceived", "REAL", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsProfitTracker.put("availableFunds", new TableInfo.Column("availableFunds", "REAL", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsProfitTracker.put("createdDate", new TableInfo.Column("createdDate", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsProfitTracker.put("lastModified", new TableInfo.Column("lastModified", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsProfitTracker.put("syncStatus", new TableInfo.Column("syncStatus", "TEXT", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsProfitTracker.put("deleted", new TableInfo.Column("deleted", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        final HashSet<TableInfo.ForeignKey> _foreignKeysProfitTracker = new HashSet<TableInfo.ForeignKey>(1);
        _foreignKeysProfitTracker.add(new TableInfo.ForeignKey("investors", "CASCADE", "NO ACTION", Arrays.asList("investorId"), Arrays.asList("uuid")));
        final HashSet<TableInfo.Index> _indicesProfitTracker = new HashSet<TableInfo.Index>(4);
        _indicesProfitTracker.add(new TableInfo.Index("index_profit_tracker_uuid", true, Arrays.asList("uuid"), Arrays.asList("ASC")));
        _indicesProfitTracker.add(new TableInfo.Index("index_profit_tracker_investorId", false, Arrays.asList("investorId"), Arrays.asList("ASC")));
        _indicesProfitTracker.add(new TableInfo.Index("index_profit_tracker_yearMonth", false, Arrays.asList("yearMonth"), Arrays.asList("ASC")));
        _indicesProfitTracker.add(new TableInfo.Index("index_profit_tracker_investorId_yearMonth", true, Arrays.asList("investorId", "yearMonth"), Arrays.asList("ASC", "ASC")));
        final TableInfo _infoProfitTracker = new TableInfo("profit_tracker", _columnsProfitTracker, _foreignKeysProfitTracker, _indicesProfitTracker);
        final TableInfo _existingProfitTracker = TableInfo.read(db, "profit_tracker");
        if (!_infoProfitTracker.equals(_existingProfitTracker)) {
          return new RoomOpenHelper.ValidationResult(false, "profit_tracker(com.moithuti.funds.data.local.entity.ProfitTrackerEntity).\n"
                  + " Expected:\n" + _infoProfitTracker + "\n"
                  + " Found:\n" + _existingProfitTracker);
        }
  ...
  protected Map<Class<?>, List<Class<?>>> getRequiredTypeConverters() {
    ...
    _typeConvertersMap.put(BufferDao.class, BufferDao_Impl.getRequiredConverters());
    ...
    _typeConvertersMap.put(MonthlyBalanceDao.class, MonthlyBalanceDao_Impl.getRequiredConverters());
    _typeConvertersMap.put(ProfitTrackerDao.class, ProfitTrackerDao_Impl.getRequiredConverters());
  ...
  public BufferDao bufferDao() {
    if (_bufferDao != null) {
      ...
      synchronized(this) {
        if(_bufferDao == null) {
          _bufferDao = new BufferDao_Impl(this);
        }
        return _bufferDao;
      }
    }
  ...
  public MonthlyBalanceDao monthlyBalanceDao() {
    if (_monthlyBalanceDao != null) {
      return _monthlyBalanceDao;
    } else {
      synchronized(this) {
        if(_monthlyBalanceDao == null) {
          _monthlyBalanceDao = new MonthlyBalanceDao_Impl(this);
        }
        return _monthlyBalanceDao;
      }
    }
  ...
  @Override
  public ProfitTrackerDao profitTrackerDao() {
    if (_profitTrackerDao != null) {
      return _profitTrackerDao;
    } else {
      synchronized(this) {
        if(_profitTrackerDao == null) {
          _profitTrackerDao = new ProfitTrackerDao_Impl(this);
        }
        return _profitTrackerDao;
      }
    }
